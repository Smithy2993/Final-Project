...
urlpatterns = [
        ...
        url(r'^edit_skill/(?P<username>[a-zA-Z0-9]+)/(?P<details_view_url>[-\w]+)/$', views.edit_skill, name='edit_skill'),
        url(r'^delete_skill/(?P<username>[a-zA-Z0-9]+)/(?P<details_view_url>[-\w]+)/$', views.delete_skill, name='delete_skill')
]
